...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float crouchJumpWindow = 0.7f;
    public float crouchJumpForce = 750f;
    ...
    private void MyInput()
    {
        ...
        crouching = Input.GetKey(KeyCode.M);
    ...
    private void Jump()
    {
        if ((grounded || isWallRunning || surfing) && readyToJump && !crouching)
        {
            ...
            float appliedJumpForce = (canHighJump && timeSinceCrouch <= crouchJumpWindow) ? crouchJumpForce : jumpForce;
            ...
            canHighJump = false; // Reset after jump
